...
export const INTRO_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: "School Leaders complete the full Educational Suitability and Facility Condition sections. Operations Staff complete only the Facility Condition (FCA) questions.",
    placement: "right",
  },
  {
