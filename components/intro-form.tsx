  ...
  return (
    <Card className="border-border/60 shadow-sm">
      <CardHeader className="pb-4">
        <CardTitle className="font-heading text-xl text-foreground">School Information</CardTitle>
        <p className="text-sm text-muted-foreground mt-1">
          Please provide details about your school to begin the assessment
        </p>
      </CardHeader>
      <CardContent className="space-y-5">
        <div className="space-y-2.5" data-tour="school-select">
          <Label htmlFor="school" className="text-foreground font-medium">Select School</Label>
        ...
        <div className="space-y-2.5" data-tour="role-select">
          ...
          <Select value={data.role} onValueChange={(v) => handleChange("role", v)}>
            <SelectTrigger
              id="role"
              className="h-auto w-full min-h-8 py-2 whitespace-normal [&_[data-slot=select-value]]:line-clamp-none [&_[data-slot=select-value]]:whitespace-normal"
            >
          ...
          {isOperations && (
            <p className="text-xs text-muted-foreground">
              Operations Staff complete only the Facility Condition Assessment questions.
            </p>
          )}
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            <Label htmlFor="principalName" className="text-foreground">Name</Label>
            <Input
              id="principalName"
        ...
        {!isOperations && (
          <>
            <div className="space-y-2">
              <Label htmlFor="schoolDescription" className="text-foreground">
            ...
            <div className="space-y-2">
              <Label htmlFor="uniqueFeatures" className="text-foreground">
            ...
            <div className="space-y-2">
              <Label htmlFor="specialEducation" className="text-foreground">
